...
public class HTTPResponse {
	...
	/**
	 * 
	 * @return Devuelve en forma de array de bytes la respuesta generada. Esto permite pasarlo directamente al socket.
	 */
	public byte[] toBytes(){
		...
		System.arraycopy(content, 0, respuesta, header.length, content.length);  //Concatenamos cabecera y contenido
		return respuesta;
	}
